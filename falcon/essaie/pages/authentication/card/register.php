...
//email
    ...
    if (empty($errors)) {
        ...
        http://localhost/sir_tech/falcon/essaie/pages/authentication/card/confirm.php?id=$userId&token=$token";
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:34 GMT -->
                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    ...
                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                      <p class="pt-3 text-white">Have an account?<br><a class="btn btn-outline-light mt-2 px-4" href="login.html">Log In</a></p>
                    </div>
                  </div>
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form class="row g-3 needs-validation"  action="" method="post">
                        <div class="mb-3">
                          ...
                          <input class="form-control" type="text" name="username" autocomplete="on" id="card-name" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="card-email">Email address</label>
                          <input class="form-control" name="email" type="email" autocomplete="on" id="card-email" /></div>
                        <div class="row gx-2">
                          <div class="mb-3 col-sm-6">
                            <label class="form-label" for="card-password">Password</label>
                            <input class="form-control" name="password" type="password" autocomplete="on" id="card-password" /></div>
                          <div class="mb-3 col-sm-6">
                            <label class="form-label" for="card-confirm-password">Confirm Password</label>
                            <input class="form-control" type="password" name="password_confirm" autocomplete="on" id="card-confirm-password" /></div>
                        </div>
