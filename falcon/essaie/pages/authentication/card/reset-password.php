...
$query = "SELECT * FROM admin WHERE id = ? AND reset_token= ? AND reset_at > DATE_SUB(NOW(), INTERVAL 130 MINUTE) AND confirmed_at IS NOT NULL ";
...
if($user){
  if (!empty($_POST)) {
    if(!empty($_POST['password']) || $_POST['password'] == $_POST['password_confirm'] ){
      ...
      $query= "UPDATE admin SET password = ?,reset_token = NULL,reset_at = NULL WHERE id = ?"; 
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:34 GMT -->
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form class="mt-3" action="" method="post">
                        <div class="mb-3">
                          ...
                          <input class="form-control" name="password" type="password" id="card-reset-password" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="card-reset-confirm-password">Confirm Password</label>
                          <input class="form-control" name="password_confirm" type="password" id="card-reset-confirm-password" />
                        </div>
