...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:33 GMT -->
                ...
                <div class="row g-0 h-100">
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                      ...
                      <!--/.bg-holder-->
                      <div class="z-index-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="../../../index.html">sir_techshop admin</a>
                        <p class="opacity-75 text-white">veillez vous authentifiez en fin de gerer le compte compte administrateur de la boutique sir_techshop</p>
                      </div>
                    </div>
                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                      <p class="mb-0 mt-4 mt-md-5 fs--1 fw-semi-bold text-white opacity-75"> <a class="text-decoration-underline text-white" href="#!"></a>  <a class="text-decoration-underline text-white" href="#!"> </a></p>
                    </div>
                  </div>
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form class="row g-3 needs-validation" action="" method="post"  >
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="pseudo">Name or Email address</label>
                        <input class="form-control" name="username" id="card-email" type="text" /></div>
                        <div class="mb-3">
                          <div class="d-flex justify-content-between">
                            <label class="form-label" for="card-password">Password</label></div>
                            <input class="form-control" name="password" id="card-password" type="password"  />
                        </div>
                        <div class="row flex-between-center">
                          <div class="col-auto">
                            <div class="form-check mb-0"><input class="form-check-input" name="remember" value="1" type="checkbox" id="card-checkbox" checked="checked" /><label class="form-check-label mb-0" for="card-checkbox">Remember me</label></div>
                          </div>
                          <div class="col-auto"><a class="fs--1" href="forgot-password.php">Forgot Password?</a></div>
                        </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:34 GMT -->
</html>