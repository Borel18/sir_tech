...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/confirm-mail.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:34 GMT -->
                  ...
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center"><img class="d-block mx-auto mb-4" src="../../../assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                        ...
                        <p>An email has been sent to <strong>you</strong>. Please click on the <br class="d-none d-sm-block d-md-none" />included link to reset your password.</p><a class="btn btn-primary btn-sm mt-3" href="login.php"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to login</a>
                      </div>
                    </div>
                  </div>
                </div>
