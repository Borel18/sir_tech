...
if ($user) {
  ...
  http://localhost/sir_tech/falcon/essaie/pages/authentication/card/reset-password.php?id=$user->id&token=$reset_token";
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:34 GMT -->
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <div class="row justify-content-center">
                        <div class="col-sm-8 col-md">
                          <form class="mb-3" class="row g-3 needs-validation" action="" method="post" >
