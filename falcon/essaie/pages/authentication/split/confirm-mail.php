...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/split/confirm-mail.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:36 GMT -->
      ...
      <div class="container-fluid">
        ...
        <div class="row min-vh-100 bg-100">
          <div class="col-6 d-none d-lg-block position-relative">
            <div class="bg-holder" style="background-image:url(../../../assets/img/generic/16.jpg);background-position: 50% 30%;"></div>
            <!--/.bg-holder-->
          </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body p-4">
                    <div class="text-center"><img class="d-block mx-auto mb-4" src="../../../assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                      ...
                      <p>An email has been sent to <strong>xyz@abc.com</strong>. Please click on the included link to reset your password.</p><a class="btn btn-primary btn-sm mt-3" href="login.html"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to login</a>
                    </div>
                  </div>
                </div>
              </div>
