...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/split/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:36 GMT -->
      ...
      <div class="container-fluid">
        ...
        <div class="row min-vh-100 bg-100">
          <div class="col-6 d-none d-lg-block position-relative">
            <div class="bg-holder" style="background-image:url(../../../assets/img/generic/20.jpg);"></div>
            <!--/.bg-holder-->
          </div>
              ...
              <div class="col-lg-9 col-xl-8 col-xxl-6">
                <div class="card">
                  ...
                  <div class="card-body p-4">
                    ...
                    <form class="mt-3">
                      <div class="mb-3"><label class="form-label" for="split-reset-password">New Password</label><input class="form-control" type="password" id="split-reset-password" /></div>
                      <div class="mb-3"><label class="form-label" for="split-reset-confirm-password">Confirm Password</label><input class="form-control" type="password" id="split-reset-confirm-password" /></div><button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Set password</button>
                    </form>
                  </div>
                </div>
              </div>
