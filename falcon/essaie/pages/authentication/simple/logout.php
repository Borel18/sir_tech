...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/simple/logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:32 GMT -->
            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="text-center"><img class="d-block mx-auto mb-4" src="../../../assets/img/icons/spot-illustrations/45.png" alt="shield" width="100" />
                  <h4>See you again!</h4>
                  <p>Thanks for using Falcon. You are <br />now successfully signed out.</p><a class="btn btn-primary btn-sm mt-3" href="login.html"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to Login</a>
                </div>
              </div>
            </div>
          </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/simple/logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:33 GMT -->
</html>