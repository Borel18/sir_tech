...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/email/email-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:53:57 GMT -->
          ...
          <div class="card">
                ...
                <div class="col-lg-8 col-xxl-6">
                  <div class="card shadow-none mb-3"><img class="card-img-top" src="../../assets/img/icons/spot-illustrations/international-women-s-day-2.png" alt="" />
                    <div class="card-body">
                      ...
                      <div class="text-center"><button class="btn btn-success btn-lg my-3" type="button">Browse Courses</button><small class="d-block">For any technical issues faced, please contact <a href="#!">Customer Support</a>.</small></div>
                    </div>
                  </div>
            ...
            <div class="card-footer">
              <div class="row justify-content-between">
                <div class="col"><a class="btn btn-falcon-default btn-sm" href="compose.html"><span class="fas fa-reply" data-fa-transform="down-2"></span><span class="d-none d-sm-inline-block ms-1">Reply</span></a><a class="btn btn-falcon-default btn-sm ms-2" href="compose.html"><span class="fas fa-location-arrow" data-fa-transform="down-2"></span><span class="d-none d-sm-inline-block ms-1">Forward</span></a></div>
                <div class="col-auto d-flex align-items-center"><small>2 of 354</small><button class="btn btn-falcon-default btn-sm ms-2" type="button"><span class="fas fa-chevron-left"></span></button><button class="btn btn-falcon-default btn-sm ms-2" type="button"><span class="fas fa-chevron-right"></span></button></div>
              </div>
            </div>
          </div>
          <footer class="footer">
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/email/email-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:53:58 GMT -->
</html>