...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/email/inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:53:53 GMT -->
          ...
          <div class="card mb-3">
            ...
            <div class="card-body fs--1 border-top border-200 p-0" id="emails">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-white dark__bg-dark" data-href="email-detail.html">
                <div class="btn-group btn-group-sm z-index-2 hover-actions end-0 me-3" style="width: 10rem;"><button class="btn btn-light" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive"><span class="fas fa-archive"></span></button><button class="btn btn-light" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="fas fa-trash-alt"></span></button><button class="btn btn-light" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark as read"><span class="fas fa-envelope-open"></span></button><button class="btn btn-light" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Snooze"><span class="fas fa-clock"></span></button></div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                <div class="btn-group btn-group-sm z-index-2 hover-actions end-0 me-3" style="width: 10rem;"><button class="btn btn-light" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Archive"><span class="fas fa-archive"></span></button><button class="btn btn-light" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="fas fa-trash-alt"></span></button><button class="btn btn-light" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Mark as unread"><span class="fas fa-envelope"></span></button><button class="btn btn-light" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Snooze"><span class="fas fa-clock"></span></button></div>
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-1" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="email-detail.html">GitHub</a></div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="email-detail.html"><span>[GitHub] Subscribed to technext/photogallery notifications</span><span class="mx-1">&ndash;</span><span>Hey there, we’re just writing to let you know that you’ve been...</span></a></div>
                  </div>
                </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-3" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="email-detail.html">Coursera</a></div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="email-detail.html"><span>Recommended: Server-side Development with NodeJS, Express and MongoDB</span><span class="mx-1">&ndash;</span><span>We combed our catalog and found courses...</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="#!"><span class="fas fa-file-archive text-warning" data-fa-transform="grow-4"></span><span class="ms-2">syllabus</span></a></div>
                  </div>
                </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-4" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="email-detail.html">Spectrum</a></div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="email-detail.html"><span>Spectrum Weekly Digest: ZEIT watercooler, Escape Room!</span><span class="mx-1">&ndash;</span><span>You didn’t gain any reputation last week. Reputation is an...</span></a></div>
                  </div>
                </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-5" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="email-detail.html">Pinterest</a></div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="email-detail.html"><span>Tony, 14 ideas in Pink saree</span><span class="mx-1">&ndash;</span><span>New ideas for you in Web Development...</span></a></div>
                  </div>
                </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-6" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="email-detail.html">Medium</a></div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="email-detail.html"><span>Technology Brief: Who’s keeping us safe?</span><span class="mx-1">&ndash;</span><span>policy at Google, Twitter, and Pinterest, says, &quot;The team starts to feel like the...</span></a></div>
                  </div>
                </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-8" data-bulk-select-row="data-bulk-select-row" /></div><span class="fas text-warning fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="email-detail.html">Stripe</a></div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="email-detail.html"><span>Confirm your Stripe email address!</span><span class="mx-1">&ndash;</span><span>Before you can start accepting live payments, you need to confirm your email address...</span></a></div>
                  </div>
                </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-9" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-10" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="email-detail.html">Youtube</a></div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="email-detail.html"><span>Firebase just uploaded a video</span><span class="mx-1">&ndash;</span><span>Firebase has uploaded Understanding Cloud Functions: Configuration settings In the last...</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="#!"><span class="fab fa-youtube text-youtube" data-fa-transform="grow-4"></span><span class="ms-2">Cloud Functions</span></a></div>
                  </div>
                </div>
              ...
              <div class="row border-bottom border-200 hover-actions-trigger hover-shadow py-2 px-1 mx-0 bg-light" data-href="email-detail.html">
                ...
                <div class="col-auto d-none d-sm-block">
                  <div class="d-flex bg-light">
                    <div class="form-check mb-0 fs-0"><input class="form-check-input" type="checkbox" id="checkbox-11" data-bulk-select-row="data-bulk-select-row" /></div><span class="far text-300 fa-star ms-1" data-fa-transform="down-4"></span>
                  </div>
                </div>
                <div class="col col-md-9 col-xxl-10">
                  <div class="row">
                    <div class="col-md-4 col-xl-3 col-xxl-2 ps-md-0 mb-1 mb-md-0">
                      <div class="d-flex position-relative">
                        ...
                        <div class="flex-1 ms-2"><a class="stretched-link inbox-link" href="email-detail.html">Bruce Banner</a></div>
                      </div>
                    </div>
                    <div class="col"><a class="d-block inbox-link" href="email-detail.html"><span>Invitation for migration</span><span class="mx-1">&ndash;</span><span>Bruce Wayne, you have an invitation of migration...</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="#!"><span class="fas fa-file-pdf text-danger" data-fa-transform="grow-4"></span><span class="ms-2">Invitation</span></a></div>
                  </div>
                </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/email/inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:53:57 GMT -->
</html>