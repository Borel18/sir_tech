...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/social/notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:24 GMT -->
            ...
            <div class="modal-content">
              ...
              <div class="modal-body p-4">
                <form class="text-start">
                  <div class="form-check lh-1 mb-0"><input class="form-check-input" type="radio" value="" id="always" name="notification-settings" /><label class="form-check-label mb-0" for="always">Get a notification each time there is activity on your page or an important update.</label></div>
                  <div class="form-check lh-1 mb-0"><input class="form-check-input" type="radio" value="" id="everyday" name="notification-settings" /><label class="form-check-label mb-0" for="everyday">Get one notification every 12-24 hours on all activity and updates.</label></div>
                  <div class="form-check lh-1 mb-0"><input class="form-check-input" type="radio" value="" id="off" name="notification-settings" /><label class="form-check-label mb-0" for="off">Off</label></div>
                  <h5 class="fs-0 mb-3 mt-4">Edit your notification settings for: </h5>
                  <ul class="list-group list-group-flush mb-4 fs--1">
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>New Mention of Page </span><span class="form-check fs-0 mb-0"><input class="form-check-input me-0" id="checkbox1" type="checkbox" name="checkbox1" checked="checked"/></span></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>New Comments on page post</span><span class="form-check fs-0 mb-0"><input class="form-check-input me-0" id="checkbox2" type="checkbox" name="checkbox2" checked="checked"/></span></li>
                    <li class="list-group-item d-flex justify-content-between align-items-center py-2 px-0 border-200 bg-transparent"><span>Edits to Comments you have written</span><span class="form-check fs-0 mb-0"><input class="form-check-input me-0" id="checkbox3" type="checkbox" name="checkbox3" checked="checked"/></span></li>
                  </ul>
                  <div class="form-check mb-0"><input class="form-check-input" type="checkbox" id="followers-activity" /><label class="form-check-label mb-0" for="followers-activity">Allow notifications from your followers activity</label></div>
                  <div class="form-check mb-0"><input class="form-check-input" type="checkbox" id="groups" /><label class="form-check-label mb-0" for="groups">Groups</label></div>
                  <div class="form-check mb-0"><input class="form-check-input" type="checkbox" id="associations" /><label class="form-check-label mb-0" for="associations">Associations</label></div>
                </form>
              </div>
              <div class="modal-footer border-top text-start py-3 px-4 d-flex justify-content-end"><button class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancel</button><button class="btn btn-primary btn-sm ms-2" type="submit">Update</button></div>
            </div>
          </div>
        </div>
      </div>
