...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:08 GMT -->
            ...
            <div class="col-xl-4 order-xl-1">
              <div class="card">
                <div class="card-header bg-light btn-reveal-trigger d-flex flex-between-center">
                  <h5 class="mb-0">Order Summary</h5><a class="btn btn-link btn-sm btn-reveal text-600" href="shopping-cart.html"><span class="fas fa-pencil-alt"></span></a>
                </div>
                <div class="card-body">
                    ...
                    <div class="row gx-0 ps-2 mb-4">
                      <div class="col-sm-8 px-3">
                        ...
                        <div class="row align-items-center">
                          ...
                          <div class="col-6"><label class="form-label ls text-uppercase text-600 fw-semi-bold mb-0">CVV<a class="d-inline-block" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Card verification value"><span class="fa fa-question-circle ms-2"></span></a></label><input class="form-control" type="text" placeholder="123" maxlength="3" pattern="[0-9]{3}" /></div>
                        </div>
                      </div>
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:09 GMT -->
</html>