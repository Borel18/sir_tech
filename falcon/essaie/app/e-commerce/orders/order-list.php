...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/orders/order-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:06 GMT -->
      ...
      <div class="container" data-layout="container">
        ...
        <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-xl" style="display: none;">
          ...
          <a class="navbar-brand me-1 me-sm-3" href="../../../index.html">
            <div class="d-flex align-items-center"><span class="font-sans-serif">sir_techshop</span></div>
          </a>
                      ...
                      <div class="row">
                        ...
                        <div class="col-6 col-md-4">
                          <div class="nav flex-column">
                            <p class="nav-link text-700 mb-0 fw-bold">E-Commerce</p><a class="nav-link py-1 link-600 fw-medium" href="../product/product-list.html">Product list</a><a class="nav-link py-1 link-600 fw-medium" href="../product/product-grid.html">Product grid</a><a class="nav-link py-1 link-600 fw-medium" href="../product/product-details.html">Product details</a><a class="nav-link py-1 link-600 fw-medium" href="order-list.html">Order list</a><a class="nav-link py-1 link-600 fw-medium" href="order-details.html">Order details</a><a class="nav-link py-1 link-600 fw-medium" href="../customers.html">Customers</a><a class="nav-link py-1 link-600 fw-medium" href="../customer-details.html">Customer details</a><a class="nav-link py-1 link-600 fw-medium" href="../shopping-cart.html">Shopping cart</a><a class="nav-link py-1 link-600 fw-medium" href="../checkout.html">Checkout</a><a class="nav-link py-1 link-600 fw-medium" href="../billing.html">Billing</a><a class="nav-link py-1 link-600 fw-medium" href="../invoice.html">Invoice</a>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="card-body p-0">
              <div class="table-responsive scrollbar">
                <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                  <thead class="bg-200 text-900">
                    <tr>
                      ...
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="order">num commande et email</th>
                      <th class="sort pe-1 align-middle white-space-nowrap pe-7" data-sort="date">Date de la commande</th>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="address" style="min-width: 12.5rem;">commande par</th>
               ...
               require_once __DIR__. '/commande.php';
                    ...
                    $id_com= strip_tags($loc->id_com);
                    
                    
                    
                    $sql = "SELECT * FROM commande WHERE (id = :id_com )";
                    
                    // on prepqre lq requete
                    $query = $db->prepare($sql);
                    
                    // executer la requete
                    $query->execute(['id_com' =>$loc->id_com ]);
                    ...
                    $email= strip_tags($result['email_cust']);

                    $sql = "SELECT * FROM custumer WHERE (email = :email )";
                    
                    // on prepqre lq requete
                    $query = $db->prepare($sql);
                    
                    // executer la requete
                    $query->execute(['email' =>$result['email_cust'] ]);
                    ...
                    <tr class="btn-reveal-trigger">
                      ...
                      <td class="order py-2 align-middle white-space-nowrap"><a href="order-details.html"> <strong>#181</strong></a> by <strong>Ricky Antony</strong><br /><a href="<?= $result['email_cust']?>"><?= $result['email_cust']?></a></td>
                      <td class="date py-2 align-middle"><?= $result['date']?></td>
                      <td class="address py-2 align-middle white-space-nowrap"><?= $result2['name']?>, <?= $result2['city']?>,<?= $result2['pays']?>,<?= $result2['tel']?><p class="mb-0 text-500">Via livraison</p>
                      </td>
                      <td class="status py-2 align-middle text-center fs-0 white-space-nowrap"><span class="badge badge rounded-pill d-block badge-soft-success"><?= $loc->statut?><span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span></td>
                      <td class="amount py-2 align-middle text-end fs-0 fw-medium"><?= $result['prix_total']?></td>
