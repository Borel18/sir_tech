...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:07 GMT -->
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end">
                        <div class="dropdown font-sans-serif position-static"><button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-1" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>
                          <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-1">
                            <div class="bg-white py-2"><a class="dropdown-item" href="customer-details.php?id=<?= $user['id']?>">detail</a><a class="dropdown-item text-danger" href="#!">Delete</a></div>
                          </div>
                        </div>
                      </td>
                    </tr>
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:08 GMT -->
</html>