...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/customer-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:08 GMT -->
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <div class="row">
                <div class="col">
                  <h5 class="mb-2"><?= $produits['name']?> (<a href="<?= $produits['email']?>.com"><?= $produits['email']?></a>)</h5><a class="btn btn-falcon-default btn-sm" href="#!"><span class="fas fa-plus fs--2 me-1"></span>Add note</a><button class="btn btn-falcon-default btn-sm dropdown-toggle ms-2 dropdown-caret-none" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h"></span></button>
            ...
            <div class="card-body border-top">
              <div class="d-flex"><span class="fas fa-user text-success me-2" data-fa-transform="down-5"></span>
                <div class="flex-1">
                  ...
                  <p class="fs--1 mb-0 text-600"><?= $produits['date']?></p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-lg col-xxl-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col"><?= $produits['id']?></div>
                  </div>
                  <div class="row">
                    <div class="col-5 col-sm-4">
                      <p class="fw-semi-bold mb-1">Created</p>
                    </div>
                    <div class="col"><?= $produits['date']?></div>
                  </div>
                  <div class="row">
                    <div class="col-5 col-sm-4">
                      <p class="fw-semi-bold mb-1">Email</p>
                    </div>
                    <div class="col"><a href="mailto:tony@gmail.com"><?= $produits['email']?></a></div>
                  </div>
                  <div class="row">
                    <div class="col-5 col-sm-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <p class="fst-italic text-400 mb-0"><?= $produits['tel']?></p>
                    </div>
                  </div>
                </div>
                <div class="col-lg col-xxl-5 mt-4 mt-lg-0 offset-xxl-1">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <p class="mb-1"><?= $produits['city']?> <br /><?= $produits['pays']?></p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-5 col-sm-4">
                    ...
                    <div class="col"><a href="tel:+12025550110"><?= $produits['tel']?></a></div>
                  </div>
                  <div class="row">
                    <div class="col-5 col-sm-4">
                      <p class="fw-semi-bold mb-0">nom d'utilisateur</p>
                    </div>
                    <div class="col">
                      <p class="fw-semi-bold mb-0"><?= $produits['last_name']?></p>
                    </div>
                  </div>
                </div>
              </div>
