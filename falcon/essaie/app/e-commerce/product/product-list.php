...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/product/product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:00 GMT -->
                ...
                <div class="search-box" data-list='{"valueNames":["title"]}'>
                  ...
                  <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                      ...
                      <a class="dropdown-item px-card py-1 fs-0" href="product-grid.html">
                      ...
                      <a class="dropdown-item px-card py-2" href="../../../pages/user/profile.php">
                        <div class="d-flex align-items-center">
              ...
              <div class="row flex-between-center">
                ...
                <div class="col-sm-auto">
                  <div class="row gx-2 align-items-center">
                    ...
                    <div class="col-auto pe-0"><a class="text-600 px-1" href="product-grid.php" data-bs-toggle="tooltip" title="Product Grid"><span class="fas fa-th"></span></a></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-0 overflow-hidden">
              ...
              <div class="col-lg-4 d-flex justify-content-between flex-column">
                ...
                <div class="mt-2">
                  <a href="addtype.php" class="btn btn-sm btn-primary d-lg-block mt-lg-2" href="#!"><span class="ms-2 d-none d-md-inline-block">ajouter un type</span></a>          
                </div>
                <div class="mt-2">
                  <a href="add.php" class="btn btn-sm btn-primary d-lg-block mt-lg-2" href="#!"><span class="ms-2 d-none d-md-inline-block">ajouter un produit</span></a>          
                </div>
                </div>
              <!-- product -->
              <?php
                ...
                <div class="col-12 p-card">
                  <div class="row">
                    <div class="col-sm-5 col-md-4">
                      <div class="position-relative h-sm-100"><a class="d-block h-100" href="product-details.php"><img class="img-fluid fit-cover w-sm-100 h-sm-100 rounded-1 absolute-sm-centered" src="../../../assets/img/products/<?= $produits['image']?>" alt="" /></a>
                    ...
                    <div class="col-sm-7 col-md-8">
                      <div class="row">
                        <div class="col-lg-8">
                          <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="product-details.php?id=<?=$produits['id']?>"><?= $produits['description']?></a></h5>
                          <p class="fs--1 mb-2 mb-md-3"><a class="text-500" href="#!"><?= $produits['nom']?> </a></p>
                          
                        </div>
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                          <div>
                            <h4 class="fs-1 fs-md-2 text-warning mb-0"><?= $produits['prix']?>FCFA</h4>
                            <h5 class="fs--1 text-500 mb-0 mt-1"><del>$2399 </del><span class="ms-1">-50%</span></h5>
                          ...
                          <a href="detail.php?id=<?=$produits['id']?>"class="btn btn-sm btn-outline-secondary border-300 d-lg-block me-2 me-lg-0" href="#!"><span class="ms-2 d-none d-md-inline-block">Detail</span></a>
                          <a href="edit.php?id=<?=$produits['id']?>"class="btn btn-sm btn-outline-secondary border-300 d-lg-block me-2 me-lg-0" href="#!"><span class="ms-2 d-none d-md-inline-block">modifier</span></a>
                          <a href="delete.php?id=<?=$produits['id']?>" class="btn btn-sm btn-primary d-lg-block mt-lg-2" href="#!"><span class="ms-2 d-none d-md-inline-block">supprimer</span></a>
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/product/product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:03 GMT -->
</html>