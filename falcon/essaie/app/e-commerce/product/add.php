<?php
  ...
  if($_POST){
     ...
     && !empty($_POST['type'])){       
       ...
       $cathegorie = strip_tags($_POST['cathegorie']);
       $type = strip_tags($_POST['type']);
       
         // on prepare la requete 

        $sql = 'INSERT INTO `produits` (`image`,`nom`,`description`,`prix`,`cathegorie`,`type`) VALUES
        (:image, :nom, :description,:prix,:cathegorie,:type);';
         ...
         $query->bindPARAM(':cathegorie', $cathegorie, PDO::PARAM_STR);
  ...
  require_once __DIR__. '/connexion.php';
         ...
         $mailler = $mail->email;
         $subject = " sirtechshop a mis un nouveau produit a ete mise a otre disposition";
         $message = "afin de retrouver nce produit veillez suivre ce lien\n\n
         http://localhost/sir_tech/monoshop/index.php";
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/simple/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:33 GMT -->
            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                ...
                <form class="row g-3 needs-validation" novalidate action="" method="post">
                  <div class="mb-3"><input  name="image" class="form-control" type="file" autocomplete="on" placeholder="veillez entrer le lien de l'image" /></div>
                  <div class="mb-3"><input name="nom" class="form-control" type="text" autocomplete="on" placeholder="Nom"  /></div>
                  <div class="mb-3"><input name="description" class="form-control" type="text" autocomplete="on" placeholder="Description" /></div>
                  <div class="mb-3"><input name="prix" class="form-control" type="number" autocomplete="on" placeholder="Prix" /></div>
                  <select name="cathegorie" id="" class="form-control" placeholder="veillez choisir la categorie">
