...
if (!empty($_POST['id']) 
    ...
    && !empty($_POST['type'])) {
        ...
        $sql = 'UPDATE `produits` SET `nom`=:nom,
            ...
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                ...
                <form class="row g-3 needs-validation" novalidate action="" method="post">
                  <div class="mb-3"><input  name="id" class="form-control" type="number" autocomplete="on" placeholder="Id" value="<?=$produits['id']?>"/></div>
                  <div class="mb-3"><input name="nom" class="form-control" type="text" autocomplete="on" placeholder="Nom" value="<?=$produits['nom']?>" /></div>
                  <div class="mb-3"><input name="description" class="form-control" type="text" autocomplete="on" placeholder="Description" value="<?=$produits['description']?>"/></div>
                  
                  <div class="mb-3"><input name="prix" class="form-control" type="number" autocomplete="on" placeholder="Prix" value="<?=$produits['prix']?>"/></div>
                  <label for="">veillez choisir la categorie</label>
                  ...
                  <label for="">de quelle type de produit s'agit il ?</label>
                  ...
                  <div class="mb-3"><button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Modifier</button></div>
                </form>
