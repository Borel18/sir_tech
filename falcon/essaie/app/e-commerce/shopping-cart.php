...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:08 GMT -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-6 col-md-4">
                          <div class="nav flex-column">
                            <p class="nav-link text-700 mb-0 fw-bold">E-Commerce</p><a class="nav-link py-1 link-600 fw-medium" href="product/product-list.html">Product list</a><a class="nav-link py-1 link-600 fw-medium" href="product/product-grid.html">Product grid</a><a class="nav-link py-1 link-600 fw-medium" href="product/product-details.html">Product details</a><a class="nav-link py-1 link-600 fw-medium" href="orders/order-list.html">Order list</a><a class="nav-link py-1 link-600 fw-medium" href="orders/order-details.html">Order details</a><a class="nav-link py-1 link-600 fw-medium" href="customers.html">Customers</a><a class="nav-link py-1 link-600 fw-medium" href="customer-details.html">Customer details</a><a class="nav-link py-1 link-600 fw-medium" href="shopping-cart.html">Shopping cart</a><a class="nav-link py-1 link-600 fw-medium" href="checkout.html">Checkout</a><a class="nav-link py-1 link-600 fw-medium" href="billing.html">Billing</a><a class="nav-link py-1 link-600 fw-medium" href="invoice.html">Invoice</a>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="search-box" data-list='{"valueNames":["title"]}'>
                  ...
                  <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                      ...
                      <a class="dropdown-item fs--1 px-card py-1 hover-primary" href="customers.html">
                        <div class="d-flex align-items-center">
                          <span class="fas fa-circle me-2 text-300 fs--2"></span>
                      ...
                      <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Suggested Filter</h6><a class="dropdown-item px-card py-1 fs-0" href="customers.html">
                      ...
                      <a class="dropdown-item px-card py-1 fs-0" href="product/product-grid.html">
          ...
          <div class="card">
            <div class="card-header">
              <div class="row justify-content-between">
                ...
                <div class="col-md-auto"><a class="btn btn-sm btn-outline-secondary border-300 me-2" href="product/product-list.html"> <span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4"></span>Continue Shopping</a><a class="btn btn-sm btn-primary" href="checkout.html">Checkout</a></div>
              </div>
            </div>
            <div class="card-body p-0">
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../../assets/img/products/1.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="product/product-details.html">Apple MacBook Pro 15&quot; Z0V20008N: 2.9GHz 6-core 8th-Gen Intel Core i9, 32GB RAM</a></h5>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../../assets/img/products/2.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="product/product-details.html">Apple iMac Pro (27-inch with Retina 5K Display, 3.0GHz 10-core Intel Xeon W, 1TB SSD)</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../../assets/img/products/4.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="product/product-details.html">Apple iPad Air 2019 (3GB RAM, 128GB ROM, 8MP Main Camera)</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../../assets/img/products/3.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="product/product-details.html">Apple iPhone XS Max (4GB RAM, 512GB ROM, 12MP Main Camera)</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../../assets/img/products/5.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="product/product-details.html">Apple Watch Series 4 44mm GPS Only</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../../assets/img/products/7.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
                      <h5 class="fs-0"><a class="text-900" href="product/product-details.html">Nikon D3200 Digital DSLR Camera</a></h5>
                      <div class="fs--2 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row gx-card mx-0 align-items-center border-bottom border-200">
                <div class="col-8 py-3">
                  <div class="d-flex align-items-center"><a href="product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../../assets/img/products/8.jpg" alt="" width="60" /></a>
                    <div class="flex-1">
