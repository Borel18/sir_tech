...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/product/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:05 GMT -->
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                  <div class="product-slider" id="galleryTop">
                    <div class="swiper-container theme-slider position-lg-absolute all-0" data-swiper='{"autoHeight":true,"spaceBetween":5,"loop":true,"loopedSlides":5,"thumb":{"spaceBetween":5,"slidesPerView":5,"loop":true,"freeMode":true,"grabCursor":true,"loopedSlides":5,"centeredSlides":true,"slideToClickedSlide":true,"watchSlidesVisibility":true,"watchSlidesProgress":true,"parent":"#galleryTop"},"slideToClickedSlide":true}'>
                      ...
                      <div class="swiper-slide h-100"><img class="rounded-1 fit-cover h-100 w-100" src="../../../assets/img/products/<?= $produits['image']?>" alt="" /></div>
 <?php
...
<?php
                ...
                foreach($result as $produit ){
                    ?>
                        ...
                        <div class="swiper-slide h-100"><img class="rounded-1 fit-cover h-100 w-100" src="../../../assets/img/products/<?= $produit['image']?>" alt="" /></div>
                ...
                <div class="col-lg-6">
                  <h5><?= $produits['nom']?></h5><a class="fs--1 mb-2 d-block" href="#!">Computer &amp; Accessories</a>
                  ...
                  <p class="fs--1"><?= $produits['description']?></p>
                  <h4 class="d-flex align-items-center"><span class="text-warning me-2"><?= $produits['prix']?></span><span class="me-1 fs--1 text-500"><del class="me-1">$2400</del><strong>-50%</strong></span></h4>
                  <p class="fs--1 mb-1"> <span>Shipping Cost: </span><strong><?= $produits['prix']?></strong></p>
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/e-commerce/product/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:06 GMT -->
</html>