                ...
                <div class="mb-4 col-md-6 col-lg-4">
                  <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                    <div class="overflow-hidden">
                      <div class="position-relative rounded-top overflow-hidden"><a class="d-block" href="#"><img class="img-fluid rounded-top" src="../../../assets/img/products/<?= $produits['image']?>" alt="" /></a><span class="badge rounded-pill bg-success position-absolute mt-2 me-2 z-index-2 top-0 end-0">New</span></div>
                      <div class="p-3">
                        <h5 class="fs-0"><a class="text-dark" href="product-details.php?id=<?=$produits['id']?>"><?= $produits['nom']?></a></h5>
                        <p class="fs--1 mb-3"><a class="text-500" href="#!"></a></p>
                        <h5 class="fs-md-2 text-warning mb-0 d-flex align-items-center mb-3"><del class="ms-2 fs--1 text-500"></del></h5>
