    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-4" href="../../../index.html"><span class="font-sans-serif fw-bolder fs-5 d-inline-block">SIR_TECHSHOP </span></a>
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="row flex-between-center mb-2">
                  <div class="col-auto">
                    <h5>Detail du produit selectioné</h5>
                  </div>
                  </div>
                <?php
  require_once __DIR__. '/config/commande.php';
                ...
                <form class="row g-3 needs-validation" novalidate action="" method="post">
                  ...
                  <section class="">
                   ...
                   <div><p>image:<?= $produits['image']?> </p></div>
                  </section>
                </form>
                <a href="categorie-list.php"><button class="btn btn-primary" type="submit">retour </button></a>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
                      <div class="modal-content position-relative">
                          ...
                          <div class="p-4 pb-0">
                            <form class="row g-3" action="updatesolde.php" method="post">
                              <div class="mb-3">
                                ...
                                <input class="form-control" name="id" id="id" type="number" value="<?=$produits['id']?>"/>
                              </div>
                              <div class="mb-3">
                                <label class="col-form-label" for="recipient-name">pourcentage reduction</label>
                                <input class="form-control" name="pourcentage_reduction" id="pourcentage_reduction" type="number" />
                              </div>
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="updatesolde.php?id=<?=$produits['id']?>"><button class="btn btn-primary" type="submit">ajouter </button></a>
                        </div>
                        </form>
                      </div>
                    </div>
