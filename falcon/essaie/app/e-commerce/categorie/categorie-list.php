          ...
          <div class="card">
            <div class="card-body p-0 overflow-hidden">
              ...
              <div class="col-lg-4 d-flex justify-content-between flex-column">
                ...
                <div class="mt-2">
                  <a href="add.php" class="btn btn-sm btn-primary d-lg-block mt-lg-2" href="#!"><span class="ms-2 d-none d-md-inline-block">ajouter une categorie</span></a>          
                </div>
                </div>
              <!-- product -->
              <?php
                ...
                <div class="col-12 p-card">
                  <div class="row">
                    <div class="col-sm-5 col-md-4">
                      <div class="position-relative h-sm-100"><a class="d-block h-100" href="categorie-details.php"><img class="img-fluid fit-cover w-sm-100 h-sm-100 rounded-1 absolute-sm-centered" src="../../../assets/img/products/<?= $produits['image']?>" alt="" /></a>
                    ...
                    <div class="col-sm-7 col-md-8">
                      <div class="row">
                        <div class="col-lg-8">
                          <h5 class="mt-3 mt-sm-0"><a class="text-dark fs-0 fs-lg-1" href="product-details.php?id=<?=$produits['id']?>"></a></h5>
                        ...
                        <div class="col-lg-4 d-flex justify-content-between flex-column">
                          <div>
                            ...
                            <div class="d-none d-lg-block">
                              <p class="fs--1 mb-1"><strong></strong></p>
