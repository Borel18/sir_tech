...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/app/events/event-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 May 2022 07:54:00 GMT -->
                ...
                <div class="col-md-6 h-100">
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-0 mb-0"><a href="event-detail.html">Crain's New York Business <span class="badge badge-soft-success rounded-pill">Free</span></a></h6>
                      <p class="mb-1">Organized by <a href="#!" class="text-700">AID MIT</a></p>
                      <p class="text-1000 mb-0">Time: 11:00AM</p>
                      <p class="text-1000 mb-0">Duration: Feb 29 - Mar 2</p>The Liberty Warehouse, New Yourk<div class="border-dashed-bottom my-3"></div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 h-100">
                  <div class="d-flex btn-reveal-trigger">
                    ...
                    <div class="flex-1 position-relative ps-3">
                      <h6 class="fs-0 mb-0"><a href="event-detail.html">Film Festival</a></h6>
                      <p class="mb-1">Organized by <a href="#!" class="text-700">American Nuclear Society</a></p>
                      <p class="text-1000 mb-0">Time: 11:00AM</p>
                      <p class="text-1000 mb-0">Duration: Feb 29 - Mar 2</p>Place: Workbar - Central Square, Cambridge<div class="border-dashed-bottom my-3"></div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 h-100">
